...
/**
    ...
    /**
     *  Load the nearby items API end point: [GET]
    ...
    /**
     * Load favorite (or visited) items API end point: [GET]
    ...
    /**
     * Load recommended items API end point: [GET]
